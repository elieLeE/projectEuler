...
liste_elem initTableHachage(char grille[NBRE_LIGNE][NBRE_COL], liste_elem l[NBRE_VAL_POSS]){
...
void liaisonTabHach(liste_elem tab_hach[NBRE_VAL_POSS], liste_elem *file_prio){
    int pos = 0, pos2 = 0;
